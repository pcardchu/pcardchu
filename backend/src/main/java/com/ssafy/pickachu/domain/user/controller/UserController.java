...
public class UserController {
    ...
    public ResponseEntity<?> loginWithKakao(@RequestBody IdTokenReq idTokenReq){
        ...
        if (!(boolean) result.get("flag_basicInfo")){
            return new ResponseEntity<>(result.get("tokenAndFlag"), HttpStatus.CREATED);
        }else{
            return new ResponseEntity<>(result.get("tokenAndFlag"), HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<?> reissueToken(@RequestBody TokenReissueReq tokenReissueReq){
        ...
        SecondTokenRes secondTokenRes = userService.reissueToken(tokenReissueReq);

        return new ResponseEntity<>(secondTokenRes, HttpStatus.OK);
